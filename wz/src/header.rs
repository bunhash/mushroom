...
pub struct Header {
    ...
    /// important for calculating offsets so it isn't modified here. The actual value used for WZ
    /// archives is signed but it probably shouldn't be.
...
impl Header {
        ...
        R: Read,
    {
        ...
        let description = String::from_utf8(description).map_err(|_| DecodeError::Header)?;
